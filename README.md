This project is a webpage dedicated to SpaceX, created using HTML, CSS, and JavaScript. The webpage fetches and displays real-time data from the SpaceX API.
# Features
